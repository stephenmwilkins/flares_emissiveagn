...
ax.scatter(Astar[s], Abh[s], s=1, c=cmap(norm(D['log10Mstar'][s])))

ax.set_ylim(ylimits)
ax.set_xlim(xlimits)

ax.set_xlabel(r'$\rm A_{FUV, \star}$')
ax.set_ylabel(r'$\rm A_{FUV, \bullet}$')

fig.savefig(f'figs/Auvbh_Auvstar.pdf')
